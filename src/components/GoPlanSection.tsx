...
const WISHES = [
  { id: 1,  text: "ดูหนังด้วยกัน 2 คน",                color: "#ffd6e7" },
  { id: 2,  text: "เที่ยวต่างประเทศ", color: "#fce4ec" },
  { id: 3,  text: "ต่อโมเดลด้วยกัน",        color: "#fff0f8" },
  { id: 4,  text: "ดินเนอร์ใต้แสงเทียน",           color: "#ffd6e7" },
  { id: 5,  text: "เที่ยวธรรมชาติ",          color: "#fce4ec" },
  { id: 6,  text: "นอนโง่ๆด้วยกันทั้งวัน",  color: "#fff0f8" },
  { id: 7,  text: "ทำเค้กด้วยกันอีกครั้ง",          color: "#ffd6e7" },
  { id: 8,  text: "กลับไปป้อมพระจุลกันอีกได้ไหม?",         color: "#fce4ec" },
  { id: 9,  text: "สร้างบ้านบนพื้นที่ของเราเอง",            color: "#fff0f8" },
  { id: 10, text: "อยู่ด้วยกันตลอดไป 🥹",            color: "#ffd6e7" },
];
