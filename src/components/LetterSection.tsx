                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ตั้งแต่วันแรกจนถึงวันนี้อาจจะบางวันที่เราไม่เข้าใจกัน ทะเลาะกันบ้าง แต่ไม่มีวันไหนเลยที่เค้ารู้สึกเสียใจที่เลือกเทอ เค้าดีใจมากๆที่วันนี้เรายังมีกันและกัน ถึงจะใช้เวลาแค่ 2 ปี แต่เราก็ผ่านอะไรมาด้วยกันเยอะ ขอบคุณเทอจริงๆนะ ที่ยังจับมือ และไม่ยอมแพ้อะไรในตัวเค้าเลย ต่อจากนี้ไปเราก็จะยังอยู่ด้วยกัน และจะผ่านทุกๆอย่างไปด้วยกัน สร้างบ้าน สร้างอนาคตด้วยกันนะ สุขสันต์วันครบรอบ 2 ปีนะ รักข้าวมากที่สุดในโลก</p>
                                    </div>
