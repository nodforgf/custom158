...
function PhotoCard({ photoUrl, idx, style, photoDate }: PhotoCardProps) {
  ...
  const messages = [
    "ดอกไม้ช่อแรกที่เทอแอบเซอไพรเค้า ทั้งที่ตอนนั้นยังไม่เป็นแฟนกันเลย 🥹",
    "13.7.67 แอบไปหาเทอที่ป้อม และเซอไพร์ขอเทอเป็นแฟนเองนะ ถึงแม้เทอจะตามจีบเค้าก็เถอะ",
    "ก่อนจะเจอเทอ เค้าเคยคิดจะไปเกาะล้านคนเดียว เพื่อฮีลใจ แต่สุดท้ายก็ได้มีแฟนที่แสนดี คอยดูแลตลอดทาง ขอบคุณนะที่ไปด้วยกัน",
    "ชอบเวลาที่เราได้ไปช้อปปิ้งด้วยกัน เทอช่วยถือของ ส่วนเราเลือกของ 🤣",
    "อีก 1 กิจกรรมที่ทำด้วยกัน และมีความสุขที่สุดคือ ไปกางเต้นท์กะเทอ ในอนาคตหากมีรถเป็นของตัวเองแล้ว ไปด้วยกันอีกนะ 🌳",
    "เป็นการถ่ายรูปเล่นๆที่เหมือน พรีเวดดิ้งมากที่สุด แต่เทอหล่อมากเลยนะ รักนะงับ ❤️",
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-3 bottom-12 flex flex-col items-center justify-center p-2 bg-[#fff8fb] rounded-sm overflow-hidden"
        ...
        >
          ...
          <div className="flex-1 w-full flex items-center justify-center overflow-y-auto px-1 custom-scrollbar" style={{ scrollbarWidth: 'none' }}>
            <p
              ...
              style={{
                fontSize: 'clamp(9px, 2.4vw, 11.5px)',
                lineHeight: '1.6',
          ...
          <span className="absolute bottom-1 text-[#e8789a]/30 text-[8px]">Tap to flip back</span>
        </div>
      </motion.div>
    </motion.div>
  );
